...
<div class="container">
    <div class="row mt-3 ">
        <h4 class="text-light">آهنگ ها</h4>
        <hr class="text-light">
        ...
        <?php else: ?>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex mt-1 align-items-center"
                                ...
                                <span class="col col-lg col-md col-sm">
                                    <img class="img-thumbnail  float-end " width="100px" src="<?php echo $music["image"] ?>"
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 mt-5 mt-sm-5 mt-md-5 mt-lg-auto d-flex flex-column justify-content-center align-items-center">
